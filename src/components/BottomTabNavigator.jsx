...
//       <Tab.Screen name="Search" component={Searching} options={{ tabBarLabel: '' , headerShown: false }} />
//       <Tab.Screen name="AddProduct" component={AddProduct} options={{ tabBarLabel: '', headerShown: false }} />
//       <Tab.Screen name="Profile" component={Profile} options={{ tabBarLabel: '' , headerShown: false }} />
//       <Tab.Screen name="Settings" component={Settings} options={{ tabBarLabel: '' , headerShown: false}} />
//     </Tab.Navigator>
//   );
// };
...
const BottomTabNavigator = () => {
  return (
    ...
    >
      ...
      <Tab.Screen name="Search" component={Searching} options={{ tabBarLabel: '' }} />
      <Tab.Screen name="AddProduct" component={AddProduct} options={{ tabBarLabel: '' }} />
